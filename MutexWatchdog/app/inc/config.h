...
// ####################### Mutex Watchdog 설정 #######################
// THREAD_WATCHDOG_ENABLE을 true로 설정하면 THREAD_WATCHDOG_OVERFLOW_TIME(ms)에 설정한
// 시간 내에 기회를 넘겨받지 못하면 mutexWatchdogHandler() 함수가 호출됩니다.
// mutexWatchdogHandler() 함수는 기본적으로 시스템을 리셋합니다.
// 사용자가 재정의하여 원하는 기능 구현이 가능합니다.
#define THREAD_WATCHDOG_ENABLE			true
#define THREAD_WATCHDOG_OVERFLOW_TIME	1000
